...
export function InvoiceA4({ invoice, settings }: InvoiceA4Props) {
    ...
    return (
        <div className="w-full max-w-[210mm] mx-auto bg-white text-black p-10 min-h-[297mm] relative">
            {/* Header */}
...
// Simple helper for demo purposes. Real implementation would be more complex or use a library.
function convertNumberToWords(amount: number) {
    // This is a placeholder. For production, install 'number-to-words' package.
