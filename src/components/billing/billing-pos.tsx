...
import { Trash2, Printer, User, Phone, MapPin, X, ShoppingCart, PlusCircle } from "lucide-react";
...
export function BillingPOS() {
    ...
    const handlePrintInvoice = (invoice: any) => {
        ...
        // Wait for styles to load (especially external links)
        setTimeout(() => {
    ...
    const handleSaveAndPrint = async () => {
        ...
        if (res.success) {
            ...
            // Use the alternative print method
    ...
    return (
        <div className="flex flex-col h-full gap-6 animate-in fade-in duration-500">
            ...
            {/* <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <Card className="bg-primary text-primary-foreground shadow-lg border-0">
                    <CardContent className="p-4 flex flex-col justify-between h-full">
                        <span className="text-primary-foreground/80 text-sm font-medium">Daily Sales</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-full items-start">
                ...
                {/* LEFT: Search Controls (Compact) */}
                <div className="lg:col-span-8 flex flex-col gap-6">

                    {/* Compact Search & Customer Bar */}
                    ...
                    {/* Active Cart List (Takes up main space now, instead of being squished) */}
            ...
            {/* No hidden div needed for iframe method, it appends dynamically */}
        </div>
    );
}
